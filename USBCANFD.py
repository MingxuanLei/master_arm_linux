...
class USBCANFD:
    ...
    ----------
    device_index:
        Linux vendor API device index. Usually 0.
    channel_index:
    ...
    def __init__(
        ...
        *,
        ...
        self.kDeviceType = self.DEFAULT_DEVICE_TYPE
    ...
    def close_device(self) -> bool:
        ...
        if self.is_open:
            ret = self.lib.VCI_CloseDevice(self.kDeviceType, self.device_index_)
            if int(ret) != 0:
                self.is_open = False
